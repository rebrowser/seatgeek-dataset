...
![Updated](https://img.shields.io/badge/updated-2026--06--06-brightgreen?style=flat-square)&nbsp;![Records](https://img.shields.io/badge/records-31.4M-blue?style=flat-square)&nbsp;[![Rebrowser](https://img.shields.io/badge/full%20dataset-rebrowser.net-orange?style=flat-square)](https://rebrowser.net/products/datasets/seatgeek)
...
> **8,563** total records from 2025-10-05 to 2026-05-31, **up to 8,563** rows in this sample (100.0% of full dataset).
...
| `endDatetimeUtc` | `datetime` | 93% | Event end datetime (UTC) |
...
| `stubhubId` | `string` | 59% | StubHub event ID (for cross-platform matching) |
...
> **235** total records from 2025-10-05 to 2026-05-31, **235** rows in this sample (100.0% of full dataset).
...
| `primaryColor` | `string` | 55% | Primary brand color hex (e.g., #0E3386) |
| `iconicColor` | `string` | 55% | Iconic brand color hex |
| `isEvent` | `bool` | 100% | Is an event/competition performer (e.g., playoffs, series) |
| `divisionName` | `string` | 53% | Division display name (e.g., National League Central) |
| `divisionShortName` | `string` | 53% | Division short name (e.g., NL Central) |
| `taxonomyName` | `string` | 100% | Top-level category (sports, concerts, theater) |
...
> **172** total records from 2025-10-12 to 2026-05-31, **172** rows in this sample (100.0% of full dataset).
> Exported as a single file, overwritten daily.
...
[Events with Pricing Data](https://rebrowser.net/products/datasets/seatgeek/events/views/events-with-pricing-data) — 6,204 records

↳ `[{"field":"averagePrice","op":"gt","value":0},{"sort":"averagePrice DESC"}]`

[Sports Events](https://rebrowser.net/products/datasets/seatgeek/events/views/sports-events) — 6,204 records

↳ `[{"field":"taxonomyName","op":"is","value":"sports"},{"sort":"datetimeUtc ASC"}]`

[Events Open for Ticket Sales](https://rebrowser.net/products/datasets/seatgeek/events/views/open-for-sale-events) — 1,610 records

↳ `[{"field":"isOpen","op":"isTrue"},{"sort":"datetimeUtc ASC"}]`

[MLB Baseball Events](https://rebrowser.net/products/datasets/seatgeek/events/views/mlb-events) — 1,326 records

↳ `[{"field":"type","op":"is","value":"mlb"},{"sort":"datetimeUtc ASC"}]`

[NBA Basketball Events](https://rebrowser.net/products/datasets/seatgeek/events/views/nba-events) — 1,640 records
...
[Sports Performers](https://rebrowser.net/products/datasets/seatgeek/performers/views/sports-performers) — 129 records
...
[NBA Performers](https://rebrowser.net/products/datasets/seatgeek/performers/views/nba-performers) — 34 records

↳ `[{"field":"type","op":"is","value":"nba"},{"sort":"name ASC"}]`

[NHL Performers](https://rebrowser.net/products/datasets/seatgeek/performers/views/nhl-performers) — 29 records
...
[Venues by Capacity](https://rebrowser.net/products/datasets/seatgeek/venues/views/venues-by-capacity) — 89 records

↳ `[{"field":"capacity","op":"gt","value":0},{"sort":"capacity DESC"}]`

[Venues in United States](https://rebrowser.net/products/datasets/seatgeek/venues/views/venues-united-states) — 80 records

↳ `[{"field":"addressCountry","op":"is","value":"US"},{"sort":"addressState ASC"}]`

[Venues in California](https://rebrowser.net/products/datasets/seatgeek/venues/views/venues-california) — 7 records

↳ `[{"field":"addressState","op":"is","value":"CA"},{"sort":"name ASC"}]`

[Venues in Florida](https://rebrowser.net/products/datasets/seatgeek/venues/views/venues-florida) — 17 records
